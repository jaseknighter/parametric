...
## Stability & Security
- Resilient Reporting: Fixed 404 regressions by aligning automated README links with an explicit nested directory structure (/monocart-report and /playwright-report).
