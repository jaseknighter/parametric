...
| :--- | :--- | :--- | :--- |
| **Logic Layer** | Statement Coverage | ✅ 83% | Jest / Node v20 |
| **Web Worker** | Branch Coverage | ✅ 86% | Jest / Node v20 |
| **Display Layer** | Statement Coverage | N/A | Playwright |
| **Smoke Suite** | Pass Rate | ✅ 100% | Playwright (Chromium) |
| **Smoke Suite** | Pass Rate | N/A | Playwright (Firefox) |
| **Smoke Suite** | Pass Rate | N/A | Playwright (WebKit) |

*Generated by `npm run test:full-baseline` on 1/21/2026, 1:58:05 PM*

[View Full Coverage Report](./monocart-report/index.html) | [View Playwright Trace](./playwright-report/index.html)

**Verification:**
To reproduce these metrics locally, run the full baseline suite:
```bash
npm run test:full-baseline
```
</details>
...
The Parametric Geometry Explorer project connects directly to that formative playful experience I had as a kid, encountering simple graphical forms on a screen, generated from not that many lines of code.
