...
| **Display Layer** | Statement Coverage | ✅ 83.81% (409/488) | Playwright |
...
*Generated by `npm run test:full-baseline` on 1/23/2026, 3:42:12 PM PST*

### 📊 Quality Dashboards
* [**Unified Coverage Report (Jest + Playwright)**](./monocart-report/index.html)
* [**Playwright Test Trace**](./playwright-report/index.html)
