...
| **Display Layer** | Statement Coverage | ⚠️ 78.4% (403/514) | Playwright |
| **Smoke Suite** | Pass Rate (Chrome) | ✅ 100% (124/124) | Playwright |
| **Smoke Suite** | Pass Rate (Firefox) | N/A | Playwright |
| **Smoke Suite** | Pass Rate (WebKit) | N/A | Playwright |

*Generated by `npm run test:full-baseline` on 1/27/2026, 6:09:57 AM UTC*
