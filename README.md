...
- [✅ Status: All Systems Nominal](#-status-all-systems-nominal)
...
| **Display Layer** | Statement Coverage | ✅ 81.55% (398/488) | Playwright |
| **Smoke Suite** | Pass Rate (Chrome) | ❌ 97% (112/115) | Playwright |
| **Smoke Suite** | Pass Rate (Firefox) | N/A | Playwright |
| **Smoke Suite** | Pass Rate (WebKit) | N/A | Playwright |

*Generated by `npm run test:full-baseline` on 1/25/2026, 4:00:08 AM UTC*

### ⚠️ Known Issues
* is visible when active (chromium)
* displays core metrics (Status, RID) (chromium)
* indicates error state (chromium)

### 📊 Quality Dashboards
* [**Unified Coverage Report (Jest + Playwright)**](https://jaseknighter.github.io/parametric/reports/coverage/index.html)
* [**Playwright Test Trace**](https://jaseknighter.github.io/parametric/reports/playwright/index.html)
